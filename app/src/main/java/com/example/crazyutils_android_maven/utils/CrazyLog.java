package com.example.crazyutils_android_maven.utils;
...
public class CrazyLog {
    ...
    //单例
    private static CrazyLog crazyLog;
    //打印调试开关
    ...
    //单例模式初始化
    public static CrazyLog getInstance() {
        if (crazyLog == null) {
            crazyLog = new CrazyLog();
        }
        return crazyLog;
    }
